...
function ScoreBar({ label, score }: { label: string; score: number }) {
  const color =
    score >= 80 ? "bg-green-500" : score >= 60 ? "bg-red-400" : "bg-orange-400";
  return (
  ...
  return (
    <div className="max-w-3xl mx-auto py-8 px-4">
      ...
      {sessionFeedback && (
        <>
          {/* 종합 점수 카드 */}
          <Card className="mb-6 border-2 border-red-100 bg-red-50">
            <CardContent className="pt-6">
              <div className="flex items-center gap-6">
                <div className="text-center">
                  ...
                  <div className="text-sm text-red-500 mt-1">종합 점수</div>
                </div>
                  ...
                  <>
                    ...
                    <div className="space-y-3">
                      ...
                      <div className="bg-red-50 border border-red-100 rounded-lg p-3">
                        <p className="text-xs font-medium text-red-600 mb-1">모범 답변 방향</p>
                        <p className="text-sm text-red-700">{q.answer.feedback.modelDirection}</p>
                      </div>
                    </div>
                  </>
                ) : (
